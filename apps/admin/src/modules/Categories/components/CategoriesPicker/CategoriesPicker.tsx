...
const CategoriesPicker = forwardRef<HTMLSelectElement, CategoriesPickerProps>(
  (props, ref) => {
    ...
    const options = useMemo(() => {
      const rows = [];
      const filtered = (categories ?? []).filter((item) => !item.deleted);
